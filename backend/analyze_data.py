...
class analyze_data_class:
    ...
    ##########  Processing for HEATING portion of cycle  ##########
                ...
                cur_cycle_material_parameters=[i,
                                               M_s_temp, M_s_strain,
                                               M_f_temp, M_f_strain,
                                               A_s_temp, A_s_strain,
                                               A_f_temp, A_f_strain,
...
#                                                      cur_plot5[0],
            ...
            # Capture cycles that were not able to be analyzed/errored.
                ...
                cur_cycle_material_parameters = [None] * 24
        ...
        # converts dictionary list to pandas DataFrame.
        df_material_parameters = pd.DataFrame.from_dict(dict_material_parameters)
