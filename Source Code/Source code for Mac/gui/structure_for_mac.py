...
# Form implementation generated from reading ui file 'structure_for_mac.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1041, 741)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(1041, 741))
        MainWindow.setMaximumSize(QtCore.QSize(1041, 741))
        font = QtGui.QFont()
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(1040, 741))
        self.centralwidget.setMaximumSize(QtCore.QSize(1040, 741))
        self.centralwidget.setAutoFillBackground(False)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 1040, 741))
        self.tabWidget.setMaximumSize(QtCore.QSize(16777213, 16777215))
        self.tabWidget.setObjectName("tabWidget")
        self.widget = QtWidgets.QWidget()
        self.widget.setObjectName("widget")
        self.label_7 = QtWidgets.QLabel(self.widget)
        self.label_7.setGeometry(QtCore.QRect(30, 422, 141, 31))
        self.label_7.setToolTip("")
        self.label_7.setStatusTip("")
        self.label_7.setObjectName("label_7")
        self.label_34 = QtWidgets.QLabel(self.widget)
        self.label_34.setGeometry(QtCore.QRect(30, 372, 1041, 31))
        font = QtGui.QFont()
        ...
        self.label_29.setGeometry(QtCore.QRect(30, 512, 511, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.open_file_button.setGeometry(QtCore.QRect(240, 50, 151, 31))
        font = QtGui.QFont()
        ...
        self.reset_inputs.setGeometry(QtCore.QRect(830, 532, 151, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.cycles_to_analyze.setGeometry(QtCore.QRect(150, 422, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.cycles_to_analyze.setFont(font)
        ...
        self.line_3.setGeometry(QtCore.QRect(10, 350, 1021, 21))
        self.line_3.setLineWidth(2)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.label_30 = QtWidgets.QLabel(self.widget)
        self.label_30.setGeometry(QtCore.QRect(400, 422, 341, 31))
        self.label_30.setObjectName("label_30")
        self.custom_cycles_to_analyze = QtWidgets.QLineEdit(self.widget)
        self.custom_cycles_to_analyze.setEnabled(False)
        self.custom_cycles_to_analyze.setGeometry(QtCore.QRect(690, 422, 321, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.custom_cycles_to_analyze.setFont(font)
        ...
        self.label_35.setGeometry(QtCore.QRect(30, 10, 1041, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_32.setGeometry(QtCore.QRect(33, 460, 1071, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.line.setGeometry(QtCore.QRect(560, 500, 20, 211))
        self.line.setLineWidth(2)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.label_11 = QtWidgets.QLabel(self.widget)
        self.label_11.setGeometry(QtCore.QRect(30, 572, 181, 31))
        self.label_11.setToolTip("")
        self.label_11.setStatusTip("")
        self.label_11.setObjectName("label_11")
        self.label_5 = QtWidgets.QLabel(self.widget)
        self.label_5.setGeometry(QtCore.QRect(30, 170, 201, 31))
        self.label_5.setObjectName("label_5")
        self.line_2 = QtWidgets.QFrame(self.widget)
        self.line_2.setGeometry(QtCore.QRect(10, 492, 1021, 21))
        self.line_2.setLineWidth(2)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_3 = QtWidgets.QLabel(self.widget)
        self.label_3.setGeometry(QtCore.QRect(30, 50, 201, 31))
        font = QtGui.QFont()
        ...
        self.display_file_name_label.setGeometry(QtCore.QRect(440, 50, 571, 31))
        font = QtGui.QFont()
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 210, 201, 31))
        self.label_6.setObjectName("label_6")
        self.export_file_name = QtWidgets.QLineEdit(self.widget)
        self.export_file_name.setGeometry(QtCore.QRect(220, 572, 311, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.export_file_name.setFont(font)
        ...
        self.label_37.setGeometry(QtCore.QRect(33, 652, 511, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_38.setGeometry(QtCore.QRect(40, 664, 501, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.analysis_status_progress_label_2.setGeometry(QtCore.QRect(720, 620, 281, 31))
        font = QtGui.QFont()
        ...
        self.analysis_status_progress_label_1.setGeometry(QtCore.QRect(600, 620, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.preview_table.setGeometry(QtCore.QRect(440, 95, 571, 221))
        ...
        self.preview_table.horizontalHeader().setDefaultSectionSize(120)
        self.preview_table.horizontalHeader().setHighlightSections(False)
        self.preview_table.horizontalHeader().setMinimumSectionSize(100)
        ...
        self.preview_table.verticalHeader().setCascadingSectionResizes(False)
        self.preview_table.verticalHeader().setDefaultSectionSize(20)
        self.preview_table.verticalHeader().setHighlightSections(False)
        self.preview_table.verticalHeader().setMinimumSectionSize(15)
        self.label_9 = QtWidgets.QLabel(self.widget)
        self.label_9.setGeometry(QtCore.QRect(30, 612, 401, 31))
        self.label_9.setObjectName("label_9")
        self.export_file_type = QtWidgets.QComboBox(self.widget)
        self.export_file_type.setGeometry(QtCore.QRect(440, 612, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.export_file_type.setFont(font)
        ...
        self.strain_col.setGeometry(QtCore.QRect(240, 210, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.strain_col.setFont(font)
        ...
        self.temp_col.setGeometry(QtCore.QRect(240, 170, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.temp_col.setFont(font)
        ...
        self.error_message_label.setGeometry(QtCore.QRect(600, 660, 401, 51))
        ...
        self.open_file_button_error.setGeometry(QtCore.QRect(390, 50, 31, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.custom_cycles_to_analyze_error.setGeometry(QtCore.QRect(1010, 422, 21, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.export_file_name_error.setGeometry(QtCore.QRect(530, 572, 31, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.display_file_name_label_error.setGeometry(QtCore.QRect(1010, 50, 21, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.temp_col_error.setGeometry(QtCore.QRect(300, 170, 21, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.strain_col_error.setGeometry(QtCore.QRect(300, 210, 21, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_47.setGeometry(QtCore.QRect(310, 412, 71, 41))
        font = QtGui.QFont()
        ...
        self.label_44.setGeometry(QtCore.QRect(33, 320, 431, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_36.setGeometry(QtCore.QRect(40, 330, 391, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_39.setGeometry(QtCore.QRect(40, 290, 421, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_45.setGeometry(QtCore.QRect(33, 280, 431, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label.setGeometry(QtCore.QRect(840, 324, 26, 26))
        self.label.setAutoFillBackground(False)
        self.label.setStyleSheet("background-color:rgb(0, 185, 80)")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.widget)
        self.label_2.setGeometry(QtCore.QRect(550, 324, 26, 26))
        ...
        self.label_17.setGeometry(QtCore.QRect(720, 324, 26, 26))
        self.label_17.setAutoFillBackground(False)
        self.label_17.setStyleSheet("background-color:rgb(86, 200, 233)")
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.widget)
        self.label_18.setGeometry(QtCore.QRect(580, 320, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(self.widget)
        self.label_19.setGeometry(QtCore.QRect(750, 320, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_19.setFont(font)
        self.label_19.setObjectName("label_19")
        self.label_20 = QtWidgets.QLabel(self.widget)
        self.label_20.setGeometry(QtCore.QRect(870, 320, 41, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_20.setFont(font)
        self.label_20.setObjectName("label_20")
        self.skip_rows = QtWidgets.QSpinBox(self.widget)
        self.skip_rows.setGeometry(QtCore.QRect(240, 130, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.skip_rows.setFont(font)
        ...
        self.label_10.setGeometry(QtCore.QRect(30, 130, 201, 31))
        self.label_10.setObjectName("label_10")
        self.temp_unit = QtWidgets.QComboBox(self.widget)
        self.temp_unit.setGeometry(QtCore.QRect(330, 170, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.strain_unit.setGeometry(QtCore.QRect(330, 210, 61, 31))
        ...
        self.label_13.setGeometry(QtCore.QRect(330, 130, 61, 31))
        self.label_13.setObjectName("label_13")
        self.label_14 = QtWidgets.QLabel(self.widget)
        self.label_14.setGeometry(QtCore.QRect(10, 70, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 0, 1111, 61))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_12.setGeometry(QtCore.QRect(20, 75, 1091, 111))
        self.label_12.setObjectName("label_12")
        self.label_15 = QtWidgets.QLabel(self.tab_3)
        self.label_15.setGeometry(QtCore.QRect(10, 190, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_16.setGeometry(QtCore.QRect(20, 195, 1091, 181))
        self.label_16.setObjectName("label_16")
        self.label_21 = QtWidgets.QLabel(self.tab_3)
        self.label_21.setGeometry(QtCore.QRect(10, 370, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_22.setGeometry(QtCore.QRect(20, 375, 1091, 131))
        self.label_22.setObjectName("label_22")
        self.label_23 = QtWidgets.QLabel(self.tab_3)
        self.label_23.setGeometry(QtCore.QRect(20, 528, 1091, 21))
        self.label_23.setObjectName("label_23")
        self.label_24 = QtWidgets.QLabel(self.tab_3)
        self.label_24.setGeometry(QtCore.QRect(10, 500, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_7.setGeometry(QtCore.QRect(10, 490, 1011, 21))
        font = QtGui.QFont()
        font.setPointSize(1)
        ...
        self.label_27.setGeometry(QtCore.QRect(10, 570, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_28.setGeometry(QtCore.QRect(20, 593, 1091, 31))
        self.label_28.setObjectName("label_28")
        self.label_31 = QtWidgets.QLabel(self.tab_3)
        self.label_31.setGeometry(QtCore.QRect(20, 613, 1091, 31))
        self.label_31.setObjectName("label_31")
        self.label_40 = QtWidgets.QLabel(self.tab_3)
        self.label_40.setGeometry(QtCore.QRect(72, 633, 1091, 31))
        self.label_40.setObjectName("label_40")
        self.label_41 = QtWidgets.QLabel(self.tab_3)
        self.label_41.setGeometry(QtCore.QRect(72, 653, 1091, 31))
        self.label_41.setObjectName("label_41")
        self.line_10 = QtWidgets.QFrame(self.tab_3)
        self.line_10.setGeometry(QtCore.QRect(10, 560, 1011, 21))
        font = QtGui.QFont()
        font.setPointSize(1)
        ...
        self.line_11.setGeometry(QtCore.QRect(10, 360, 1011, 21))
        font = QtGui.QFont()
        font.setPointSize(1)
        ...
        self.line_12.setGeometry(QtCore.QRect(10, 180, 1011, 21))
        font = QtGui.QFont()
        font.setPointSize(1)
        ...
        self.line_13.setGeometry(QtCore.QRect(10, 50, 1011, 21))
        font = QtGui.QFont()
        font.setPointSize(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_33.setText(_translate("MainWindow", "will make the program analyze cycles 1 through 25, cycle 100, cycle 1000, and cycle 5000."))
        self.label_32.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; vertical-align:super;\">3</span> Enter a list of individual cycles or cycles ranges to analyze. Separate each item in the list with a comma. Ranges can be specified using a hyphen. For example, entering   &quot;1-25,100,1000,5000&quot; </p></body></html>"))
        ...
        self.display_file_name_label.setToolTip(_translate("MainWindow", "Displays the name of the selected file"))
        ...
        self.preview_table.setToolTip(_translate("MainWindow", "Shows preview of selected file and the selected columns"))
...
"[JOURNAL NAME] (YEAR), DOI: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"))
        ...
        self.label_16.setText(_translate("MainWindow", "This software provides a Graphical User Interface (GUI) to allow users to easily input their own experimental data into the tool. This tool then performs the following \n"
"functions:\n"
"i) identify thermal cycles from the raw data.\n"
"ii) apply a pre-defined set of processes to determine twenty-three (23) material properties/parameters, including the four (4) transformation start/finish points. \n"
"    All but three of these properties are defined within the aforementioned ASTM standard.\n"
"iii) create figures showing the evolution of key properties, alongside an animation showing the tangent line fitting used to determine the transformation \n"
"     start/finish points.\n"
"iv) export the figures, animation, and a spreadsheet/txt document containing the numerical values for each of the properties obtained from each cycle."))
        self.label_21.setText(_translate("MainWindow", "Installation"))
        self.label_22.setText(_translate("MainWindow", "This project was developed in Python 3.7.3. *If* you plan on using the source code, rather than an application (.exe or unix executable) format, then you will need \n"
"to download the same packages used in developing this project. All packages and versions used in developing this application can be found in the provided \n"
"\"requirements.txt\" file. These packages can be easily downloaded by running the following in your command prompt (or Terminal, etc.):\n"
...
"             matthewkuner@yahoo.com"))
        ...
        self.label_27.setText(_translate("MainWindow", "Author Information"))
        self.label_28.setText(_translate("MainWindow", "Matthew Kuner"))
        self.label_31.setText(_translate("MainWindow", "e-mails: matthewkuner@gatech.edu"))
        self.label_40.setText(_translate("MainWindow", "matthewkuner@gmail.com"))
        self.label_41.setText(_translate("MainWindow", "matthewkuner@yahoo.com"))
